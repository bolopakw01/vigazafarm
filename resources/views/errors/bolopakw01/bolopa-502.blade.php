...
<style>
	...
	.big502{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;font-weight:900;color:#ffffff;opacity:0.12;font-size:clamp(12rem,18vw,32rem);letter-spacing:0.02em;z-index:1;pointer-events:none;text-shadow:0 2px 8px rgba(0,0,0,0.45);font-family:Anton,sans-serif;text-transform:uppercase}
	...
	@media(max-width:480px){.card{height:300px}.overlay h1{font-size:1.25rem}.overlay p{font-size:1rem}.big502{font-size:8rem;opacity:0.12}}
...
@section('content')
  <div class="wrap split-wrap">
    <div class="split-card" role="group" aria-label="502 split card">
      <div class="split-left">
        <div class="card" role="region" aria-label="Bad Gateway 502">
          <div class="noise_bg" aria-hidden="true"></div>
          <div class="big502" aria-hidden="true">502</div>
					<div class="overlay">
						<h1><span class="badge">BAD GATEWAY</span></h1>
						<p>Server tetangga lagi Ngambek!, jalur macet.</p>
					</div>
        </div>
      </div>

      <div class="split-right" role="region" aria-label="502 info panel">
        <div class="right-content">
		  ...
		  <h2>Gangguan di Jalur Tengah</h2>
		  <p>Server perantara lagi ngadat—ibarat jalan pakan tersumbat. Coba muat ulang atau kembali ke Dashboard. Kalau tetap macet, hubungi admin.</p>
          <div class="actions">
