    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3">
            <div>
                ...
                <h2 class="mb-1">Produksi Telur</h2>
                ...
                <div class="text-muted small d-flex flex-wrap gap-3">
                    ...
                    <span><i class="fa-solid fa-egg me-1"></i>Awal Telur: {{ number_format($produksi->jumlah_telur ?? 0) }} butir</span>
                    <span><i class="fa-solid fa-scale-balanced me-1"></i>Berat Rata-rata: {{ $produksi->berat_rata_telur !== null ? number_format($produksi->berat_rata_telur, 2, ',', '.') . ' g' : '-' }}</span>
                </div>
            </div>
