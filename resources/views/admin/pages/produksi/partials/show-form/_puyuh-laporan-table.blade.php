                    ...
                    <tbody>
                        @forelse ($laporanHarian as $laporan)
                            <tr>
                                ...
                                <td>{{ $laporan->penjualan_puyuh_ekor !== null ? number_format($laporan->penjualan_puyuh_ekor) : '-' }}</td>
                        ...
                        @empty
                            <tr>
                                <td colspan="8" class="text-center text-muted py-3">Belum ada catatan harian.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
