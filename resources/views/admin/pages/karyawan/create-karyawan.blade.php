          ...
          <div class="col-md-6">
            ...
            <div class="employee-photo-card" data-employee-photo data-initial-photo="">
              <div class="employee-avatar-wrapper">
                ...
                <div class="employee-avatar employee-avatar-initial" data-avatar-initial>{{ $employeeInitialLetter }}</div>
              </div>
              <div class="d-flex flex-column gap-2 flex-grow-1">
                <div class="employee-photo-actions">
                  ...
                  <button type="button" class="btn btn-sm btn-outline-danger" data-remove-button disabled>
