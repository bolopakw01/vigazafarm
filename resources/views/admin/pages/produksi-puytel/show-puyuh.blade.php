...
@section('title', 'Detail Produksi Puyuh - ' . ($produksi->batch_label ?? 'Tanpa Kode Batch'))

@php
    $breadcrumbs = [
        ['label' => 'Backoffice', 'link' => route('admin.dashboard')],
        ['label' => 'Produksi', 'link' => route('admin.produksi')],
        ['label' => 'Detail Produksi', 'badge' => $produksi->batch_label],
    ];
@endphp
...
@section('content')
    @php
        ...
        $initialPopulation = $produksi->batchProduksi->jumlah_awal
