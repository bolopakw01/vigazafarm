                            ...
                            <div class="bolopa-tabel-actions">
                                ...
                                <button type="button"
                                    ...
                                    onclick="showDetailModal(@js([
                                        ...
                                        'formatted_tanggal_simpan_telur_waktu' => optional($item->created_at)->format('d/m/Y H:i'),
                                        ...
                                        'formatted_tanggal_menetas_waktu' => optional($item->tanggal_menetas ? $item->updated_at : null)->format('d/m/Y H:i'),
                                        ...
                                        'formatted_dibuat_pada' => optional($item->created_at)->format('d/m/Y H:i'),
                                        'formatted_diperbarui_pada' => optional($item->updated_at)->format('d/m/Y H:i'),
