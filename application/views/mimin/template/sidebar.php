    ...
    <div class="tab-content mt-3">
        <div <?php if ($thisPage == "opr") echo "class='tab-pane fade show active'";
            ...
            <nav class="sidebar-nav">
                <ul class="metismenu">
                    <li <?php if ($thisPg == "dashboard") echo "class='active'"; ?>><a href="<?= base_url('backoffice'); ?>"><i><img src="<?= base_url('assets/back/images/home.png'); ?>" height="20px" width="20px" /></i><span>Dashboard</span></a></li>
                    <li <?php if ($thisPg == "penetasan") echo "class='active'"; ?>><a href="<?= base_url('backoffice/penetasan'); ?>"><i><img src="<?= base_url('assets/back/images/chick.png'); ?>" height="20px" width="20px" /></i><span>Penetasan</span></a> </li>
                    <li <?php if ($thisPg == "pembesaran") echo "class='active'"; ?>><a href="<?= base_url('backoffice/pembesaran'); ?>"><i><img src="<?= base_url('assets/back/images/blue.png'); ?>" height="20px" width="20px" /></i><span>Pembesaran</span></a></li>
                    <li <?php if ($thisPg == "produksi") echo "class='active'"; ?>><a href="<?= base_url('backoffice/produksi'); ?>"><i><img src="<?= base_url('assets/back/images/egg.png'); ?>" height="20px" width="20px" /></i><span>Produksi</span></a></li>
        ...
        <div <?php if ($thisPage == "master") echo "class='tab-pane fade show active'";
            ...
            <nav class="sidebar-nav">
                <ul class="metismenu">
                    <li <?php if ($thisPg == "kandang") echo "class='active'"; ?>><a href="<?= base_url('backoffice/kandang'); ?>"><i><img src="<?= base_url('assets/back/images/farm.png'); ?>" height="20px" width="20px" /></i><span>Kandang</span></a></li>
                    <li <?php if ($thisPg == "karyawan") echo "class='active'"; ?>><a href="<?= base_url('backoffice/karyawan'); ?>"><i><img src="<?= base_url('assets/back/images/people.png'); ?>" height="20px" width="20px" /></i><span>Karyawan</span></a></li>
                </ul>
            </nav>
        </div>
    </div>
                    ...
                    <div class="notification d-flex">
                        ...
                        <div class="dropdown d-flex">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                ...
                                <a class="dropdown-item" href="app-email.html"><span class="float-right"><span class="badge badge-primary">6</span></span><i class="dropdown-icon fe fe-mail"></i> Message</a>
                                <a class="dropdown-item" href="javascript:void(0)"><i class="dropdown-icon fe fe-send"></i> Log</a>
                                <div class="dropdown-divider"></div>
