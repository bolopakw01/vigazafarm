<div class="row">
	<div class="col-lg-6">
		<div class="card m-b-30">
			<?php echo form_open_multipart('backoffice/update_profil'); ?>
			<div class="card-body">
				<div class="row">
					<div class="col-md-12">
					...
					<div class="col-md-12">
						<input type="hidden" class="form-control" name="minid" value="<?= $profil['minid']; ?>" />
						...
						<div class="form-group">
							...
							<div>
								<input type="text" name="uname" class="form-control" value="<?= $profil['username']; ?>" />
							</div>
						</div>
						<div class="form-group">
							<label>Username</label>
