...
<body>
    ...
    <div class="container">
      <div class="left">
        <div class="login animate__animated animate__bounceIn">
          <center>
            <img src="<?php echo base_url('assets/back/images/logo.png'); ?>" width="176px" height="120px" />
            <br /><?= $this->session->flashdata('pesan') ?>
          </center>
        </div>
        <div class="eula animate__animated animate__bounce">
          <center style="font-weight: bold; font-size: 20px; color: #000;">VigazaFarm System <br /> <span class="blink_me" style="font-size: 12px">LOGIN ADMIN</span></center>
        </div>
      </div>
      <div class="right">
  ...
  <script>
    ...
    // Debug: Check if flashdata exists
    <?php 
    $alert = $this->session->flashdata('alert');
    if($alert): 
    ?>
    console.log('Flash alert data found:', <?php echo json_encode($alert); ?>);
    <?php else: ?>
    console.log('No flash alert data found');
    <?php endif; ?>
    
    // SweetAlert notification handler
    <?php if($alert): ?>
      $(document).ready(function() {
        console.log('SweetAlert triggered with data:', <?php echo json_encode($alert); ?>);
        var alertConfig = {
