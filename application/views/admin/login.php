    ...
    <div class="container">
      <div class="left">
        ...
        <div class="eula animate__animated animate__bounce">
          <center style="font-weight: bold; font-size: 20px; color: #000;">Basketball System <br /> <span class="blink_me" style="font-size: 12px">LOGIN ADMIN</span></center>
        </div>
      </div>
      <div class="right">
        ...
        <?php echo form_open("siadmin/auth"); ?>
