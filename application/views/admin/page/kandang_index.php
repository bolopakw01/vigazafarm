    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center ">
            <div class="header-action">
                <h1 class="page-title">Kandang</h1>
                <ol class="breadcrumb page-breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Vigaza Farm</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Kandang</li>
                </ol>
            </div>
                            ...
                            ?>
                                    <tr>
                                        <td class="w60">
                                            ...
                                            $words = $row->nama;
                                            ?>
                                            <div class="avatar avatar-pink" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?= $words; ?>">
                                                <span>
                                                    <?php
                                                    $process = explode(" ", $words);
                                                    $acronym = "";

                                                    foreach ($process as $w) {
                                        ...
                                        <td>
                                            <div class="font-15"><?= $row->nama; ?></div>
                                        </td>
                                        <td><?= $row->alamat; ?></td>
                                        <td><strong><?= $row->tgl_berdiri; ?></strong></td>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <button class="btn btn-icon btn-sm"><i class="fa fa-eye"></i></button>
                                    <button class="btn btn-icon btn-sm"><i class="fa fa-edit"></i></button>
                                    <button class="btn btn-icon btn-sm text-danger"><i class="fa fa-trash-o"></i></button>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-6">
            ...
            <div id="modal-insert" class="modal fade" style="width: 100%;">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <form method="post" enctype="multipart/form-data" action="<?= base_url('backoffice/in_kandang'); ?>">
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <label>Tanggal Berdiri Kandang</label>
                                            <input type="date" id="lama_tgl_lahir" class="form-control" name="tgl_berdiri" placeholder="Tanggal Berdiri Kandang" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" id="lama_nama" class="form-control" name="nama_kandang" placeholder="Nama Kandang" required>
                                        </div>
                                        <!-- <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <select class="form-control select2" name="kamar" id="dtNya" onchange="changeValue(this.value)" required>
                                                ...
                                                foreach ($kamar as $r) {
                                                ?>
                                                    <option value="<?= $r->id_kamar ?>"><?= ucwords($r->jenis) . ' - ' . ucwords($r->nomor) . ' (' . ucwords($r->cabang) . ')'; ?></option>
                                                <?php
                                                    $jsArray .= "dtItem['" . $r->id_kamar . "'] = {id_cabangnya:'" . addslashes($r->id_cabang) . "',cabangnya:'" . addslashes($r->cabang) . "',id_jenisnya:'" . addslashes($r->id_jenis_kamar) . "'};\n";
                                                }
                                                ?>
                                            </select>
                                        </div>
