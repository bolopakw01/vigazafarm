                        ...
                        <div class="row clearfix">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="card w_social_state2">
                                    <div class="card-body">
                                        <div class="content">
                                            <div class="text">Kematian</div>
                                            <h4 class="mb-3">231 ekor</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <div class="card-body">
                                        <div class="content">
                                            <div class="text">Pakan</div>
                                            <h4 class="mb-3">231 zak</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-md-flex justify-content-between">
                                    <div>
                                        <h6 class="mb-1">Grafik Kematian</h6>
                                        <span class="text-muted">Data diambil dari input harian</span>
                                    </div>
                                    <div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="card">
                                    <div class="card-body">
                                        <span><b>KEMATIAN</b></span>
                                        <a href="javascript:void();" data-toggle="modal" data-target="#modal-insert-km"><button type="button" class="btn bcg-biru pull-right"><i class="fa fa-plus"></i></button></a>
                                        <div class="table-responsive">
                                            <br />
                                            <table class="table table-hover js-basic-example dataTable table-striped table_custom border-style spacing5">
                                                <thead>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="card">
                                    <div class="card-body">
                                        <span><b>PAKAN</b></span>
                                        <a href="javascript:void();" data-toggle="modal" data-target="#modal-insert-pk"><button type="button" class="btn bcg-biru pull-right"><i class="fa fa-plus"></i></button></a>
                                        <div class="table-responsive">
                                            <br />
                                            <table class="table table-hover js-basic-example dataTable table-striped table_custom border-style spacing5">
                                                <thead>
...
<!-- MODAL INSERT OPEN -->
<div id="modal-insert-km" class="modal fade" style="width: 100%;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form method="post" enctype="multipart/form-data" action="<?= base_url('backoffice/in_kematian'); ?>">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <label>Tanggal</label>
                                <input type="date" id="lama_tgl_lahir" class="form-control" name="tgl_masuk" placeholder="Tanggal Masuk" value="<?=date('Y-m-d');?>" required>
                            </div>
                            <input type="hidden" name="uriseg" value="<?= $this->uri->segment(3); ?>">
                            <div class="form-group">
                                <input type="number" id="lama_nama" class="form-control" name="populasi_awal" placeholder="Jumlah (Ekor)" required>
                            </div>
                            <div class="form-group">
...
<!-- MODAL INSERT OPEN -->
<div id="modal-insert-pk" class="modal fade" style="width: 100%;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title">
            ...
            <form method="post" enctype="multipart/form-data" action="<?= base_url('backoffice/in_pakan'); ?>">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <input type="hidden" name="uriseg" value="<?= $this->uri->segment(3); ?>">
                            ...
                            <input type="hidden" name="uriseg" value="<?= $this->uri->segment(3); ?>">
                            <div class="form-group">
                                <input type="number" id="lama_nama" class="form-control" name="populasi_awal" placeholder="Jumlah (Zak)" required>
                            </div>
                            <div class="form-group">
                                <textarea id="lama_ket" class="form-control" name="ket" placeholder="Keterangan"></textarea>
                            </div>
