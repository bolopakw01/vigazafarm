        ...
        <div class="card-body">
            <ul class="list-group list-unstyled">
                <li class="list-group-item mb-2">
                    <p>Light Version</p>
                    <a href="../university/index.html"><img src="<?= base_url('assets/'); ?>images/themes/default.png" class="img-fluid" alt="" /></a>
                </li>
                <li class="list-group-item mb-2">
                    <p>Dark Version</p>
                    <a href="../university-dark/index.html"><img src="<?= base_url('assets/'); ?>images/themes/dark.png" class="img-fluid" alt="" /></a>
                </li>
                <li class="list-group-item mb-2">
                    <p>RTL Version</p>
                    <a href="../university-rtl/index.html"><img src="<?= base_url('assets/'); ?>images/themes/rtl.png" class="img-fluid" alt="" /></a>
                </li>
            </ul>
        </div>
    </div>
...
<!-- Demo content temporarily hidden for farm management system -->
<!--
<div class="user_div">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li>
                            <div class="clearfix">
                                ...
                                <div class="float-right"><small class="text-muted">Biological Sciences</small>
                                </div>
                            </div>
                            <div class="progress progress-xxs">
                ...
                <div class="chat_windows">
                    <ul class="mb-0">
                        <li class="other-message">
                            <img class="avatar mr-3" src="<?= base_url('assets/'); ?>images/xs/avatar1.jpg" alt="avatar">
                            <div class="message">
                        ...
                        <li class="other-message">
                            <img class="avatar mr-3" src="<?= base_url('assets/'); ?>images/xs/avatar1.jpg" alt="avatar">
                            <div class="message">
                                <p class="bg-light-blue">Hi Aiden, how are you? How is the project coming along?
                                </p>
                                <p class="bg-light-blue">Are we meeting today?</p>
                        ...
                        <li class="my-message">
                            <div class="message">
                                <p class="bg-light-gray">Project has been already finished and I have results to
                                    show you.</p>
                        ...
                        <li class="other-message">
                            ...
                            <div class="message">
                                <div class="media_img">
                                    <img src="<?= base_url('assets/'); ?>images/gallery/1.jpg" class="w100 img-thumbnail" alt="">
                                    <img src="<?= base_url('assets/'); ?>images/gallery/2.jpg" class="w100 img-thumbnail" alt="">
                                </div>
                                <span class="time">10:15 AM, Today</span>
                            </div>
                        </li>
...
<div id="left-sidebar" class="sidebar">
    <h5 class="brand-name">Vigaza Farm<a href="javascript:void(0)" class="menu_option float-right"><i class="icon-grid font-16" data-toggle="tooltip" data-placement="left" title="Grid & List Toggle"></i></a></h5>
    <ul class="nav nav-tabs">
        <li class="nav-item"><a <?php if ($thisPage == "opr") echo "class='nav-link active'";
                                else echo "class='nav-link'"; ?> data-toggle="tab" href="#menu-uni">Operasional</a></li>
        <?php if($this->session->userdata('isLevel') == 'super_admin'): ?>
        <li class="nav-item"><a <?php if ($thisPage == "master") echo "class='nav-link active'";
                                else echo "class='nav-link'"; ?> data-toggle="tab" href="#menu-admin">Master</a></li>
        <li class="nav-item"><a <?php if ($thisPage == "super") echo "class='nav-link active'";
                                else echo "class='nav-link'"; ?> data-toggle="tab" href="#menu-super">Super Admin</a></li>
        <?php endif; ?>
    </ul>
    <div class="tab-content mt-3">
        <div <?php if ($thisPage == "opr") echo "class='tab-pane fade show active'";
                else echo "class='tab-pane fade'"; ?> id="menu-uni" role="tabpanel">
            <nav class="sidebar-nav">
                <ul class="metismenu">
                    <li <?php if ($thisPg == "dashboard") echo "class='active'"; ?>><a href="<?= base_url('dashboard'); ?>"><i><img src="<?= base_url('assets/back/images/home.png'); ?>" height="20px" width="20px" /></i><span>Dashboard</span></a></li>
                    <li <?php if ($thisPg == "penetasan") echo "class='active'"; ?>><a href="<?= base_url('penetasan'); ?>"><i><img src="<?= base_url('assets/back/images/chick.png'); ?>" height="20px" width="20px" /></i><span>Penetasan</span></a> </li>
                    <li <?php if ($thisPg == "pembesaran") echo "class='active'"; ?>><a href="<?= base_url('pembesaran'); ?>"><i><img src="<?= base_url('assets/back/images/blue.png'); ?>" height="20px" width="20px" /></i><span>Pembesaran</span></a></li>
                    <li <?php if ($thisPg == "produksi") echo "class='active'"; ?>><a href="<?= base_url('produksi'); ?>"><i><img src="<?= base_url('assets/back/images/egg.png'); ?>" height="20px" width="20px" /></i><span>Produksi</span></a></li>
                    <!-- <li><a href="taskboard.html"><i class="fa fa-list-ul"></i><span>Pakan</span></a></li>
                    <li><a href="hostel.html"><i class="fa fa-bed"></i><span>Inventaris</span></a></li>
                    <li><a href="payments.html"><i class="fa fa-credit-card"></i><span>Karyawan</span></a></li> -->
                </ul>
            </nav>
        </div>
        <?php if($this->session->userdata('isLevel') == 'super_admin'): ?>
        <div <?php if ($thisPage == "master") echo "class='tab-pane fade show active'";
                else echo "class='tab-pane fade'"; ?> id="menu-admin" role="tabpanel">
            <nav class="sidebar-nav">
                <ul class="metismenu">
                    <li <?php if ($thisPg == "kandang") echo "class='active'"; ?>><a href="<?= base_url('kandang'); ?>"><i><img src="<?= base_url('assets/back/images/farm.png'); ?>" height="20px" width="20px" /></i><span>Kandang</span></a></li>
                    <li <?php if ($thisPg == "karyawan") echo "class='active'"; ?>><a href="<?= base_url('karyawan'); ?>"><i><img src="<?= base_url('assets/back/images/people.png'); ?>" height="20px" width="20px" /></i><span>Karyawan</span></a></li>
                </ul>
            </nav>
        </div>
        <?php endif; ?>
        <?php if($this->session->userdata('isLevel') == 'super_admin'): ?>
        <div <?php if ($thisPage == "super") echo "class='tab-pane fade show active'";
                else echo "class='tab-pane fade'"; ?> id="menu-super" role="tabpanel">
            <nav class="sidebar-nav">
                <ul class="metismenu">
                    <li><a href="<?= base_url('settings'); ?>"><i class="fa fa-cogs text-warning"></i><span>System Settings</span></a></li>
                    <li><a href="<?= base_url('user-management'); ?>"><i class="fa fa-users text-info"></i><span>User Management</span></a></li>
                    <li><a href="<?= base_url('workflow'); ?>"><i class="fa fa-sitemap text-success"></i><span>Workflow Logs</span></a></li>
                    <li><a href="<?= base_url('analytics'); ?>"><i class="fa fa-bar-chart text-primary"></i><span>Analytics</span></a></li>
                    <li><a href="<?= base_url('backup'); ?>"><i class="fa fa-database text-danger"></i><span>Database Backup</span></a></li>
                    <li><a href="<?= base_url('logs'); ?>"><i class="fa fa-file-text text-muted"></i><span>System Logs</span></a></li>
                </ul>
            </nav>
        </div>
        <?php endif; ?>
                ...
                <div class="right">
                    <ul class="nav nav-pills">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Kandang</a>
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="login.html">Palgading</a>
                                <a class="dropdown-item" href="register.html">Cangkringan</a>
                    ...
                    <div class="notification d-flex">
                                ...
                                <ul class="list-unstyled feeds_widget">
                                    <li>
                                        ...
                                        <div class="feeds-body ml-3">
                                            <p class="text-muted mb-0">Campaign <strong class="text-blue font-weight-bold">Holiday</strong> is
                                    ...
                                    <li>
                                        ...
                                        <div class="feeds-body ml-3">
                                            <p class="text-muted mb-0">New admission <strong class="text-green font-weight-bold">32</strong> in computer
                                                department.</p>
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <div class="feeds-body ml-3">
                                            <p class="text-muted mb-0">6th sem result <strong class="text-red font-weight-bold">67%</strong> in computer
                                                department.</p>
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <div class="feeds-body ml-3">
                                            <p class="text-muted mb-0">New Feedback <strong class="text-azure font-weight-bold">53</strong> for
                        ...
                        <div class="dropdown d-flex">
                            <a href="javascript:void(0)" class="chip ml-3" data-toggle="dropdown">
                                ...
                                <?php echo $this->session->userdata('isUname'); ?>
                                <?php if($this->session->userdata('isLevel') == 'super_admin'): ?>
                                    <small class="badge badge-danger ml-1">SUPER</small>
                                <?php elseif($this->session->userdata('isLevel') == 'mimin'): ?>
                                    <small class="badge badge-primary ml-1">ADMIN</small>
                                <?php endif; ?>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                <div class="dropdown-header">
                                    <strong><?php echo $this->session->userdata('isUname'); ?></strong><br>
                                    <small class="text-muted">
                                        <?php 
                                        $level = $this->session->userdata('isLevel');
                                        echo $level == 'super_admin' ? 'Super Administrator' : 'Administrator';
                                        ?>
                                    </small>
                                </div>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="<?php echo base_url('dashboard/profil'); ?>"><i class="dropdown-icon fe fe-user"></i> Profile</a>
                                <?php if($this->session->userdata('isLevel') == 'super_admin'): ?>
                                <a class="dropdown-item" href="<?php echo base_url('settings'); ?>"><i class="dropdown-icon fe fe-settings"></i> Settings</a>
                                <?php endif; ?>
                                <a class="dropdown-item" href="<?php echo base_url('dashboard/log'); ?>"><i class="dropdown-icon fe fe-send"></i> Log Activity</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="<?php echo base_url('mimin/logout'); ?>"><i class="dropdown-icon fe fe-log-out"></i> Sign out</a>
                            </div>
                        </div>
                    </div>
                </div>
