...
class LookerMasterExportBuilder
{
    ...
    /**
     * Schema definitions for Looker Studio mapping (dimensions/metrics and types).
     */
    public function schema(): array
    {
        return [
            'meta_summary' => [
                ['name' => 'metric', 'type' => 'STRING', 'role' => 'DIMENSION', 'description' => 'Nama metrik ringkasan'],
                ['name' => 'value', 'type' => 'STRING', 'role' => 'DIMENSION', 'description' => 'Nilai ringkasan'],
                ['name' => 'unit', 'type' => 'STRING', 'role' => 'DIMENSION', 'description' => 'Satuan'],
                ['name' => 'notes', 'type' => 'STRING', 'role' => 'DIMENSION', 'description' => 'Catatan'],
            ],
            'goals_snapshot' => [
                ['name' => 'key', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'title', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'target', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'current', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'unit', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'color', 'type' => 'STRING', 'role' => 'DIMENSION'],
            ],
            'financial_snapshot' => [
                ['name' => 'category', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'label', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'amount', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'notes', 'type' => 'STRING', 'role' => 'DIMENSION'],
            ],
            'iot_settings' => [
                ['name' => 'mode', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'api_endpoint', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'api_key', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'device_id', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'update_interval', 'type' => 'NUMBER', 'role' => 'METRIC'],
            ],
            'penetasan' => [
                ['name' => 'penetasan_id', 'type' => 'NUMBER', 'role' => 'DIMENSION'],
                ['name' => 'batch', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'kandang', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'status', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'tanggal_simpan_telur', 'type' => 'DATE', 'role' => 'DIMENSION'],
                ['name' => 'estimasi_tanggal_menetas', 'type' => 'DATE', 'role' => 'DIMENSION'],
                ['name' => 'tanggal_menetas', 'type' => 'DATE', 'role' => 'DIMENSION'],
                ['name' => 'jumlah_telur', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'jumlah_doc', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'jumlah_menetas', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'telur_tidak_fertil', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'telur_infertil_ditransfer', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'doc_ditransfer', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'persentase_tetas', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'suhu_penetasan', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'kelembaban_penetasan', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'updated_at', 'type' => 'DATETIME', 'role' => 'DIMENSION'],
            ],
            'pembesaran' => [
                ['name' => 'pembesaran_id', 'type' => 'NUMBER', 'role' => 'DIMENSION'],
                ['name' => 'kandang', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'sumber_penetasan', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'tanggal_masuk', 'type' => 'DATE', 'role' => 'DIMENSION'],
                ['name' => 'tanggal_selesai', 'type' => 'DATE', 'role' => 'DIMENSION'],
                ['name' => 'tanggal_siap', 'type' => 'DATE', 'role' => 'DIMENSION'],
                ['name' => 'jumlah_anak_ayam', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'jumlah_siap', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'indukan_ditransfer', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'status_batch', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'umur_hari', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'berat_rata_rata', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'target_berat_akhir', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'catatan', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'updated_at', 'type' => 'DATETIME', 'role' => 'DIMENSION'],
            ],
            'produksi' => [
                ['name' => 'produksi_id', 'type' => 'NUMBER', 'role' => 'DIMENSION'],
                ['name' => 'kandang', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'tipe_produksi', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'jenis_input', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'tanggal_mulai', 'type' => 'DATE', 'role' => 'DIMENSION'],
                ['name' => 'tanggal_akhir', 'type' => 'DATE', 'role' => 'DIMENSION'],
                ['name' => 'jumlah_telur', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'jumlah_indukan', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'jumlah_jantan', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'jumlah_betina', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'umur_mulai_produksi', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'berat_rata_rata', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'berat_rata_telur', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'persentase_fertil', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'harga_per_pcs', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'harga_per_kg', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'status', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'catatan', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'sumber_penetasan', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'sumber_pembesaran_id', 'type' => 'NUMBER', 'role' => 'DIMENSION'],
                ['name' => 'updated_at', 'type' => 'DATETIME', 'role' => 'DIMENSION'],
            ],
            'pencatatan_produksi' => [
                ['name' => 'catatan_id', 'type' => 'NUMBER', 'role' => 'DIMENSION'],
                ['name' => 'produksi_id', 'type' => 'NUMBER', 'role' => 'DIMENSION'],
                ['name' => 'kandang', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'tanggal', 'type' => 'DATE', 'role' => 'DIMENSION'],
                ['name' => 'jumlah_produksi', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'kualitas', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'berat_rata_rata', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'harga_per_unit', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'total_pendapatan', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'catatan', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'updated_at', 'type' => 'DATETIME', 'role' => 'DIMENSION'],
            ],
            'pakan' => [
                ['name' => 'pakan_id', 'type' => 'NUMBER', 'role' => 'DIMENSION'],
                ['name' => 'produksi_id', 'type' => 'NUMBER', 'role' => 'DIMENSION'],
                ['name' => 'batch_produksi_id', 'type' => 'NUMBER', 'role' => 'DIMENSION'],
                ['name' => 'tanggal', 'type' => 'DATE', 'role' => 'DIMENSION'],
                ['name' => 'jumlah_kg', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'sisa_pakan_kg', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'jumlah_karung', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'harga_per_kg', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'total_biaya', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'feed_item', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'feed_category', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'kandang', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'updated_at', 'type' => 'DATETIME', 'role' => 'DIMENSION'],
            ],
            'kesehatan' => [
                ['name' => 'kesehatan_id', 'type' => 'NUMBER', 'role' => 'DIMENSION'],
                ['name' => 'batch_produksi_id', 'type' => 'NUMBER', 'role' => 'DIMENSION'],
                ['name' => 'tanggal', 'type' => 'DATE', 'role' => 'DIMENSION'],
                ['name' => 'tipe_kegiatan', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'nama_vaksin_obat', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'jumlah_burung', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'biaya', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'petugas', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'catatan', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'updated_at', 'type' => 'DATETIME', 'role' => 'DIMENSION'],
            ],
            'kematian' => [
                ['name' => 'kematian_id', 'type' => 'NUMBER', 'role' => 'DIMENSION'],
                ['name' => 'batch_produksi_id', 'type' => 'NUMBER', 'role' => 'DIMENSION'],
                ['name' => 'produksi_id', 'type' => 'NUMBER', 'role' => 'DIMENSION'],
                ['name' => 'tanggal', 'type' => 'DATE', 'role' => 'DIMENSION'],
                ['name' => 'jumlah', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'penyebab', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'keterangan', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'updated_at', 'type' => 'DATETIME', 'role' => 'DIMENSION'],
            ],
            'monitoring_lingkungan' => [
                ['name' => 'monitoring_id', 'type' => 'NUMBER', 'role' => 'DIMENSION'],
                ['name' => 'kandang', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'batch_produksi_id', 'type' => 'NUMBER', 'role' => 'DIMENSION'],
                ['name' => 'waktu_pencatatan', 'type' => 'DATETIME', 'role' => 'DIMENSION'],
                ['name' => 'suhu', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'kelembaban', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'intensitas_cahaya', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'kondisi_ventilasi', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'catatan', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'updated_at', 'type' => 'DATETIME', 'role' => 'DIMENSION'],
            ],
            'kandang' => [
                ['name' => 'kandang_id', 'type' => 'NUMBER', 'role' => 'DIMENSION'],
                ['name' => 'kode_kandang', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'nama_kandang', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'tipe_kandang', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'status', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'kapasitas_maksimal', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'kapasitas_terpakai', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'deleted_at', 'type' => 'DATETIME', 'role' => 'DIMENSION'],
                ['name' => 'created_at', 'type' => 'DATETIME', 'role' => 'DIMENSION'],
                ['name' => 'updated_at', 'type' => 'DATETIME', 'role' => 'DIMENSION'],
            ],
            'users' => [
                ['name' => 'user_id', 'type' => 'NUMBER', 'role' => 'DIMENSION'],
                ['name' => 'nama', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'username', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'email', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'peran', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'alamat', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'created_at', 'type' => 'DATETIME', 'role' => 'DIMENSION'],
                ['name' => 'updated_at', 'type' => 'DATETIME', 'role' => 'DIMENSION'],
            ],
            'laporan_operasional_harian' => [
                ['name' => 'tanggal', 'type' => 'DATE', 'role' => 'DIMENSION'],
                ['name' => 'kode_batch', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'nama_kandang', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'fase_produksi', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'populasi_aktif', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'kematian_ekor', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'produksi_telur_butir', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'telur_rusak_butir', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'pakan_terpakai_kg', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'biaya_pakan_harian', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'pendapatan_harian', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'profit_harian', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'fcr_harian', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'hdp_persen', 'type' => 'NUMBER', 'role' => 'METRIC'],
            ],
            'master_status_populasi' => [
                ['name' => 'kode_batch', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'fase', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'tanggal_mulai', 'type' => 'DATE', 'role' => 'DIMENSION'],
                ['name' => 'tanggal_selesai', 'type' => 'DATE', 'role' => 'DIMENSION'],
                ['name' => 'populasi_awal', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'populasi_akhir', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'total_kematian', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'total_transfer', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'status_batch', 'type' => 'STRING', 'role' => 'DIMENSION'],
            ],
            'stok_inventaris' => [
                ['name' => 'item', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'kategori', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'satuan', 'type' => 'STRING', 'role' => 'DIMENSION'],
                ['name' => 'stok', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'harga_satuan', 'type' => 'NUMBER', 'role' => 'METRIC'],
                ['name' => 'nilai_persediaan', 'type' => 'NUMBER', 'role' => 'METRIC'],
            ],
        ];
    }
